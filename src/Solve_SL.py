...
ocean_time_grid=OCEAN_TIME_GRID(time_step,maxdeg,grid_name='OCEAN_26_512')
...
topo_it=0
while topo_diff>10**(0) and sdel_topo_diff>1 : #and sdel_topo_diff>10**(-1):
    ...
    print(topo_it,' : ',topo_diff, topo_diff_mean, sdel_topo_diff,track_conv-(topo_it>0))
...
ocean_time_grid.time_step=ocean_time_grid.time_step[1:]
ocean_time_grid.height_time_grid=ocean_time_grid.height_time_grid[1:,:,:]
ocean_time_grid.save(Output_way+Love_numbers)
ice_time_grid.time_grid_name='ice_ICE6G_26_512'
ice_time_grid.height_time_grid=ice_time_grid.height_time_grid[1:,:,:]
ice_time_grid.save(Output_way+Love_numbers)
topo_time_grid.time_grid_name='topo_topo_SL_26_512'
topo_time_grid.height_time_grid=topo_time_grid.height_time_grid[1:,:,:]
