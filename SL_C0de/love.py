...
class LOVE(object):
    ...
    way : !!!! A corriger !!!! 
        ...
        self.k=1+np.repeat(self.k_e,np.arange(1,maxdeg+1,1))
        ...
        self.beta_G_l=k_ve[data,:maxdeg].squeeze()-k_e[:maxdeg]
        ...
        self.beta_R_l=h_ve[data,:maxdeg].squeeze()-h_e[:maxdeg]
